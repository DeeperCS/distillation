...
if __name__ == '__main__':
    # model = densenet(num_classes=100, depth=40, growthRate=12, compressionRate=1, dropRate=0)
    # model = densenet(num_classes=100, depth=100, growthRate=12, compressionRate=1, dropRate=0)
    model = densenet(num_classes=100, depth=40, growthRate=12, compressionRate=1, dropRate=0)
